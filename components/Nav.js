            ...
            <div className={styles.container}>
                ...
                <div className={styles.links}>
                    <div className={current === "/" ? styles.active : styles.single}>
                        <Link href="/" title="home" passHref><a>Home</a></Link>
                    </div>
                    <div className={current === "/about" ? styles.active : styles.single}>
                        <Link href="/about" title="about" passHref><a>About</a></Link>
                    </div>
                    <div className={current === "/staff" ? styles.active : styles.single}>
                        <Link href="/staff" title="staff" passHref><a>Staff</a></Link>
                    </div>
                    <div className={current === "/events" ? styles.active : styles.single}>
                        <Link href="/events" title="events" passHref><a>Events</a></Link>
                    </div>
                </div>
                ...
                {isOpen ? (
                    <div className={styles.mobileNav}>
                        ...
                        <div onClick={mobileNav}>
                            <Link href="/staff" title="staff">Staff</Link>
                        </div>
                        <div onClick={mobileNav}>
