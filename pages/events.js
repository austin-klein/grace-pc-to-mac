        ...
        <section className={styles.events}>
          <div className={styles.container}>
            ...
            <div className={styles.content}>
              ...
              <p>We have worship every single Sunday at 11:00AM, come be with us!</p>
            </div>
          </div>
          <div className={styles.container}>
            <div className={styles.image}>
            ...
            <div className={styles.content}>
              <h1>Potluck</h1>
              <p>
                We have a church potluck every fourth Sunday of the month, and it is a great time of
                fellowship.
              </p>
            </div>
          </div>
          <div className={styles.container}>
            ...
            <div className={styles.content}>
              ...
              <p>We have annual Christmas Eve and Easter services, come join us in celebration!</p>
            </div>
          </div>
        </section>
      </main>
